  ...
  plugins: [
    new ModuleFederationPlugin({
      ...
      shared: {
        ...
        // FEDERATION ISSUE: shell declares lodash as shared, catalog does not
        // → asymmetric sharing — invisible per-app, caught only by federation analysis
        lodash: { requiredVersion: '^4.17.21', eager: true },
      },
    }),
